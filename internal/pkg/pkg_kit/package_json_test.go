	...
	jsonInfo = `
{
  ...
  "author": {
    "name": "bridgewwater",
    "email": "bridgewwater@gmail.com",
    "url": "https://github.com/bridgewwater/gin-api-swagger-temple"
  }
}
`
	jsonInfoGoStyle = `
{
  ...
  "homepage": "https://github.com/bridgewwater/gin-api-swagger-temple#readme"
}
`
)
...
func TestGetPackageJsonAuthor(t *testing.T) {
	...
	assert.Equal(t, "bridgewwater@gmail.com", GetPackageJsonAuthor().Email)
}
...
func TestGetPackageJsonHomepage(t *testing.T) {
	...
	InitPkgJsonContent(jsonInfoGoStyle)
	assert.Equal(t, "https://github.com/bridgewwater/gin-api-swagger-temple#readme", GetPackageJsonHomepage())
}
